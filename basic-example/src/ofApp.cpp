...
void ofApp::setup() {
	...
	settingsXml.addInt("nocheinint", 0);
	...
	// values with no default value are mandatory. If there's no appr. entry in XML, program will be aborted
	settingsXml.addFloat("nocheinefloat");
